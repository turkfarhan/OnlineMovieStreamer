  ...
  <body>
    <header>
      <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark ">
            ...
            <span class="navbar-text">FarhanFlims</span>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1>Free! Free! Free! <br>Watch Anytime...<br>Watch Anywhere...</h1> <br>
    ...
    <section class="features">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4">
              <p class="arrange"><img src="images/mob.png" alt=""> <br> Lorem ipsum dolor sit amet, consectetur adipisicing elit,
              ...
              <p class="arrange"><img src="images/mess.png" alt=""> <br> Lorem ipsum dolor sit amet, consectetur adipisicing elit,
              ...
              <div class="col-md-4">
                ...
                <p class="arrange">
                  <img src="images/desktop.jpg"> <br>   Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod 
    ...
    <footer class="page-footer font-small blue">
      ...
      <div class="footer-copyright text-center py-3">© 2020 Copyright:
        <a href="">farhanpasha2000@gmail.com</a>
      </div>
